-- ServerScriptService/ServerModules/Services/InventoryService
...
-- persistence signal at the InventoryService boundary instead of exposing DataManager.
function InventoryService.MarkDirty(player: Player): boolean
	return DataManager.MarkDirty(player)
end
