-- StarterPlayer/StarterPlayerScripts/ClientModules/UI/MythlingPreviewUtil
...
local previewAssets = ReplicatedStorage:WaitForChild("Assets"):WaitForChild("MythlingPreviews")
