-- StarterPlayer/StarterPlayerScripts/ClientModules/Controllers/NoClimbController

local NoClimbController = {}

function NoClimbController.Start(_context: any)
...
function NoClimbController.Destroy()
end
