...
-- Modules
local Ui = script:FindFirstAncestor("ClientModules"):WaitForChild("UI")
...
local MythlingsData = require(ReplicatedStorage:WaitForChild("SharedModules"):WaitForChild("Metadata"):WaitForChild("Mythlings"))
local MaterialsMeta = require(ReplicatedStorage.SharedModules.Metadata.Materials)
local EquipmentMeta = require(ReplicatedStorage.SharedModules.Metadata.Equipment)
...
local inventoryGui = Players.LocalPlayer:WaitForChild("PlayerGui"):WaitForChild("InventoryGui")
