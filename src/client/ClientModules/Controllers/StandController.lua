...
local MythlingsMeta = require(ReplicatedStorage:WaitForChild("SharedModules"):WaitForChild("Metadata"):WaitForChild("Mythlings"))
local MaterialsMeta = require(ReplicatedStorage:WaitForChild("SharedModules"):WaitForChild("Metadata"):WaitForChild("Materials"))
