...
local ConsumablesMeta = require(ReplicatedStorage:WaitForChild("SharedModules"):WaitForChild("Metadata"):WaitForChild("Consumables"))
...
local screenGui = Players.LocalPlayer:WaitForChild("PlayerGui"):WaitForChild("HotbarGui")
